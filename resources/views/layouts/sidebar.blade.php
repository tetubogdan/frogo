    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard', Auth::user()->restaurant->id) }}" class="nav-link">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.editSchedule', Auth::user()->restaurant->id) }}" class="nav-link">
                        <i class="nav-icon fas fa-calendar-alt"></i>
                        <p>Edit Schedule</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.editCustomizations', Auth::user()->restaurant->id) }}" class="nav-link">
